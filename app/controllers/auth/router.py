...
from app.models.domain.auth import TokenRequest, TokenResponse, ErrorResponse, RefreshTokenRequest
...
async def get_token(request: TokenRequest):
    ...
    return TokenResponse(
        ...
        refresh_expires_in=settings.REFRESH_TOKEN_EXPIRE_DAYS * 24 * 60 * 60  # Convert days to seconds
    )
