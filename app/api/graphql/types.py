...
class ProductDataType:
    ...
    fc_ingreso_producto_monto: Optional[float] = strawberry.field(description="Product revenue amount")
    fc_retirado_carrito_cant: Optional[int] = strawberry.field(description="Removed from cart quantity")
    fc_detalle_producto_cant: Optional[int] = strawberry.field(description="Product detail views count")
    ...
    desc_categoria_producto: Optional[str] = strawberry.field(description="Product category (detailed)")
    desc_categoria_prod_principal: Optional[str] = strawberry.field(description="Main product category")
...
class ProductFilterInput:
    ...
    limit: Optional[int] = strawberry.field(default=100, description="Maximum number of records (max 1000)")
